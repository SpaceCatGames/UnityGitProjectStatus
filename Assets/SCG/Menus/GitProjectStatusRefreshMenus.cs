...
namespace SCG.GitProjectStatus
{
    ...
    /// </summary>
    internal static class GitProjectStatusRefreshMenus
    {
        ...
        private static void SetManualRefreshMode() => GitProjectStatusSettings.ApplyRefreshMode(GitRefreshMode.ManualOnly);

        [MenuItem(Constants.RefreshModeTimedMenuPath, false, 2002)]
        private static void SetTimedRefreshMode() => GitProjectStatusSettings.ApplyRefreshMode(GitRefreshMode.Timed);

        [MenuItem(Constants.RefreshModeEventDrivenMenuPath, false, 2003)]
        private static void SetEventDrivenRefreshMode() => GitProjectStatusSettings.ApplyRefreshMode(GitRefreshMode.EventDriven);
        ...
        {
            Menu.SetChecked(menuPath, GitProjectStatusSettings.RefreshMode == refreshMode);
            return true;
        }
    }
}
